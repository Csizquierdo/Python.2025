...
print (f"por extension  {dato =}      y es {salida}")
#----------------------------------------por comprension - Operador ternario

salida = "positivo" if dato >0 else "negativo"
print (f"por comprension - Operador ternario {dato =}      y es {salida}")
#################################################################################
#----------------------------------------por extension
if dato >0:
    salida = "positivo"
...
salida = "positivo" if dato >0 else ( "negativo" if dato <0 else "cero es neutro")
