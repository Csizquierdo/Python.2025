...
pausa()
limpiar()
entrada = [1,9,7,5,3,6,4,2,8,5,3]

def fun_meror_que_5 (edad):
    if edad < 5:
        return True# edad
    # ~ else:
        # ~ return False# None
...
salida = []
for cada_edad in entrada:
    regreso = fun_meror_que_5 (cada_edad)
    if regreso is True:
        salida.append(cada_edad)
print (f"""
{entrada=}
{salida=}
""")  
...
salida = []
for cada_edad in entrada:
    if fun_meror_que_5 (cada_edad) is True:
        salida.append(cada_edad)
print (f"""
{entrada=}
{salida=}
...
salida_comp= [cada_edad for cada_edad in entrada if fun_meror_que_5 (cada_edad) is True]
...
#------------------------------------------------------------
salida_f =filter (fun_meror_que_5,entrada)
