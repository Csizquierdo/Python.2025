...
for dato in entrada:
    if dato >0:
        ...
        salida.append("cero es neutro")
print (f"""
por extension  
{entrada =}  
{type(salida)=}        
{salida  =}""")
#----------------------------------------por comprension - Operador ternario
#                           ESTO ES UNA PORQUERIA
salida2 = []
for dato in entrada:
    salida2.append ("positivo" if dato >0 else ( "negativo" if dato <0 else "cero es neutro")   )# OPERADOR TERNARIO PURO

print (f"""
por comprension  a medias
{entrada =}  
{type(salida2)=}        
{salida2 =}""")
...
salida3 = ["positivo" if dato >0 else ( "negativo" if dato <0 else "cero es neutro")  for dato in entrada ]
...
#                               ONE LINE COMPREHENSION DICT

salida3 = {dato: "positivo" if dato >0 else ( "negativo" if dato <0 else "cero es neutro")  for dato in entrada }
...
{type(salida3)=}    
{salida3 =}""")
#                               ONE LINE COMPREHENSION SET

salida3 = { f"positivo_{dato}" if dato >0 else ( f"negativo_{dato}" if dato <0 else "cero es neutro")  for dato in entrada }
...
#                               ONE LINE COMPREHENSION 'generator'

salidaT = (f"positivo_{dato}" if dato >0 else ( f"negativo_{dato}" if dato <0 else "cero es neutro")  for dato in entrada )
...
#                               ONE LINE COMPREHENSION TUPLE 

salidaT = tuple(f"positivo_{dato}" if dato >0 else ( f"negativo_{dato}" if dato <0 else "cero es neutro")  for dato in entrada )
