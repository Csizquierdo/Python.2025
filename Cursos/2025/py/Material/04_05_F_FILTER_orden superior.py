...
print ("^"*50)
menor_cero=[]
for dato in menor_cero:#<<<objeto filter
    print (F"datos menor que cero (True en el return) {dato=}")
...
print(list(filter(filtro_mayor_q_10, numbers)))
print(list(filter(lambda number: True if number > 10 else False, numbers)))
