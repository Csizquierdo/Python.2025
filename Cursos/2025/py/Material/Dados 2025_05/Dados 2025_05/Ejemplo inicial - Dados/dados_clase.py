...
class juego_dados:
    ...
    '''     creo el objeto GUI con el nombre ventana                                                                                                            '''
        ...
        self.botonJugar = tk.Button(text="Jugar", command=self.jugar)
        '''     ubico el objeto 'botonJugar, en x=50 e y = 50
                doy un tamaño al objeto 'botonJugar,  width=100(ancho), height=30(alto)                                                                             '''
        self.botonJugar.place(x=50, y=50, width=100, height=30)
        ##############################################################################################
        ...
        self.etiqueta_nombre = tk.Label(text="Ingresa tu nombre")
        ...
        self.salida.config(font=("Courier", 24))
        '''     doy al objeto "Label" "salida" ubicación y tamaño                                                                                                   '''
        self.salida.place(x=230, y=190)
        ##############################################################################################
        ...
        self.resultado.config(font=("Courier", 24))
        '''     doy al objeto "Label" "resultado" ubicación y tamaño                                                                                                '''
        self.resultado.place(x=200, y=230)
        ##############################################################################################
