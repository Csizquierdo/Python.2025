...
def jugar(apuesta,numero,mensaje_1,mensaje_2,saldo):
    ...
    if not (numero_fun.isnumeric() and int(numero_fun)>=2 and int (numero_fun)<=12) : 
...
def makewindows():
    ...
    saldo.config( bg="white", fg="#00ff00",font=("Arial", 20))
